...
Vorformulierung: mehr prozent durchfallen (größere Anzahl) als mit sehr guter Leistung abschließen, steigt mit zunehmender SD an. Doppelte Anzahl an Note die in die Berechnung einfließen bei 13-15 im vergleich zu 0-5 punkte

Warum?

Vorformuierung: mehr Noten werde betrachtet zum durchfallen als für gute Noten
...
Das ist ein **_insignifikanter_** Unterschied, da 1.49<1.55 (Nullhypothese wird damit abgelehnt)
...
Das ist ein **_signifikanter_** Unterschied, da 1.66>1.55 (Nullhypothese wird beibehalten).

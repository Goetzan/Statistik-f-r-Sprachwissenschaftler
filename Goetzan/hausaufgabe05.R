...
# (Keine explizite Antwort nötig, nur eine Überlegung.)
# Es fehlten der Studiengang Germanistische Linguistik und Other, da, wie oben bereits
# erwähnt, für eine Verteilung zu wenige Studentinnen (1 bzw 2) teilgenommen haben/ im 
# Kurs sind. Eine Verteilung der Dichte ist somit nicht möglich.

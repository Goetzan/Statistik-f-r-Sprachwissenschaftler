...
summary(lm.3)
# nun wird aber der Output sehr unübersichtlich, Lösung mehrfaktorielle ANOVA?
...
anova.3 <- aov(price~carat*clarity*cut*x, data=diamonds)
summary(anova.3)

# ohne die Interaktioneffekte

anova.4 <- aov(price ~ carat + clarity + cut + color, data=diamonds)
summary(anova.4)
